    ...
    <div class="container mt-5">
        ...
        <div class="text-center mt-4">
            <?php if ($role === 'Admin'): ?>
                ...
                <a href="<?php echo BASE_URL; ?>/views/admin/manage_questions.php" class="btn btn-success">Manajemen Pertanyaan</a>
                <a href="<?php echo BASE_URL; ?>/views/admin/activity_logs.php" class="btn btn-warning">Log Aktivitas</a>
            <?php elseif ($role === 'Manajemen TI'): ?>
                ...
                <a href="<?php echo BASE_URL; ?>/views/manajemen_ti/score_view.php" class="btn btn-success">Lihat Skor</a>
                <a href="<?php echo BASE_URL; ?>/views/manajemen_ti/audit_history.php" class="btn btn-warning">Riwayat Audit</a>
            <?php elseif ($role === 'IT Auditor'): ?>
                <a href="<?php echo BASE_URL; ?>/views/auditor/audit_view.php" class="btn btn-primary">Lihat Audit</a>
                <a href="<?php echo BASE_URL; ?>/views/auditor/recommendations.php" class="btn btn-success">Rekomendasi Perbaikan</a>
            <?php elseif ($role === 'Tim Penilai'): ?>
                ...
                <a href="<?php echo BASE_URL; ?>/views/tim_penilai/verify_assessment.php" class="btn btn-success">Verifikasi Self-Assessment</a>
                <a href="<?php echo BASE_URL; ?>/views/tim_penilai/rankings.php" class="btn btn-warning">Lihat Ranking</a>
            <?php else: ?>
